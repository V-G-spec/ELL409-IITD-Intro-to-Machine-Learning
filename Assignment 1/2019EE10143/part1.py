...
def setup():
    ...
    parser.add_argument("--X", default="1A.csv", type=str, help = "Read content from the file")
    parser.add_argument("--show_err", default="False", type=str, help = "Show error for the weights produced")
...
if __name__ == '__main__':
    ...
    if (show_err.lower()=="true"):
        show_err = True
    elif(show_err.lower()=="false"):
        show_err = False
    if (method=="pinv"):
